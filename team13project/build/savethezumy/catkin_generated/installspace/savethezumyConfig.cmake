...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'savethezumy' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/team13/team13project/install/${idir}'.  Ask the maintainer 'team13 <team13@todo.todo>' to fix it.")
    endif()
