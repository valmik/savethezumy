...
tolerance = 5 # safety factor in degrees
...
q5 = np.array([-l_2 - l_3, -l_4, l_1])
# BS 6th joint that we don't need
omega6 = np.array([0, 0, 0])
q6 = np.array([-l_2 - l_3, -l_4, l_1 - l_5])
qe = np.array([-l_2 - l_3, -l_4 - l_6, l_1 - l_5])
