...
def main():
    ...
    # # orien_const.orientation.x = -0.5718;
    # # orien_const.orientation.y = -0.4117;
    # # orien_const.orientation.z =  0.5842;
    # # orien_const.orientation.w = -0.4026;
    # # orien_const.absolute_x_axis_tolerance = 1.1;
    # # orien_const.absolute_y_axis_tolerance = 1.1;
    # # orien_const.absolute_z_axis_tolerance = 1.1;
